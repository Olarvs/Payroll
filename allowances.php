							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-danger delete_allowances" type="button" data-id="<?php echo $row['id'] ?>">Archive</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.delete_allowances').click(function(){
		_conf("Are you sure to archive this allowances?","delete_allowances",[$(this).attr('data-id')])
	})
